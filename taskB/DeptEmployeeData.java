...
public class DeptEmployeeData {
	...
	class MemberInnerClass implements Comparator<DeptEmployee> {
	...
	public static void main(String[] args) {
		...
		DeptEmployeeData.MemberInnerClass innerMemberClass = new DeptEmployeeData().new MemberInnerClass();

		DeptEmployee[] data = getDeptData();

		Arrays.sort(data, innerMemberClass);

		System.out.println("Sorting by name using member inner class");
